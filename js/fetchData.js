...
const criarGrafico = resposta => {
    ...
    meuGrafico = new Chart(contexto, {
        type: 'pie', 
        data: {
            labels: ['Mortes', 'Confirmados', 'Confirmados descartados', 'Mortes descartadas'],
            datasets: [{
                data: [dadosDaAPI.deaths, dadosDaAPI.confirmed, dadosDaAPI.confirmed_diff, dadosDaAPI.deaths_diff],
